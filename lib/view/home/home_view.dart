          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: const [
                      _ProgressStat("Questions", "847"),
                      _ProgressStat("Accuracy", "78%"),
                      _ProgressStat("Study Streak", "12 days"),
                    ],
                  ),
            ...
            GridView.count(
              ...
              children: const [
                ...
                _PracticeTile(Icons.show_chart, "Performance", Colors.green),
                _PracticeTile(
                  Icons.offline_bolt,
                  "Offline Mode",
                  Colors.orange,
                ...
                _PracticeTile(Icons.emoji_events, "Leaderboard", Colors.amber),
              ],
            ),
            ...
            _ActivityItem("Physics Mock Test #12", "Score: 78%"),
            _ActivityItem("Chemistry Practice", "30 questions solved"),
            ...
            _ScheduleItem("Organic Chemistry Practice", "High Priority"),
            _ScheduleItem("Math – Calculus Revision", "Medium"),
            _ScheduleItem("Physics Mock Test", "High Priority"),
          ],
        ),
      ),
    );
